...
router.get('/:id', function(req, res) {
  ...
  Match.find({'players': req.params.id, 'map': {$in: maps_filter}, 'result': {$in: result_filter}})
    ...
    /*  if(maps_filter == undefined){
      ...
      var averages = {'rating': 0, 'rating_t': 0, 'rating_ct': 0, 'adr':0, 'adr_t':0, 'adr_ct':0, 'kdd':0, 'kpr':0, 'kpr_t':0, 'kpr_ct':0, 'trades':0, 'hs':0, 'kills':0, 'assists':0, 'deaths':0, 'clutches':0, 'fiveK':0};
